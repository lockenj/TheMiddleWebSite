...
<section id="characters_page" data-ng-controller="CharactersCtrl">
  <door-frame>
    <div id="characters_selector">
      <img class="selection_indicator {{charactersFctry.getSelectedCharacter().name}}" src="/images/selection_indicator.png"/>
      <img src="/images/characters/{{char.name}}_head.png" data-ng-repeat="char in charactersFctry.getCharacters()" alt="{{char.name}}'s head." data-ng-click="charactersFctry.setSelectedCharacter(char)"/>
    </div>
